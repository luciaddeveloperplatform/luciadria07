...
// Create WFS Layer "States" and make it selectable
const wfsLayer = LayerFactory.createFeatureLayer(wfsModel, {label: "States", selectable:true});
...
const poiLayer = LayerFactory.createFeatureLayer(poiModel, {label: "Points of interest", selectable: true});
// Assigning the new painter
poiLayer.painter = new POIPainter();
